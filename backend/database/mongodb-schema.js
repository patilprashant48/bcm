...
module.exports = {
    ...
    UserScheme: mongoose.model('UserScheme', new mongoose.Schema({
        userId: { type: mongoose.Schema.Types.ObjectId, ref: 'User', required: true },
        schemeId: { type: mongoose.Schema.Types.ObjectId, ref: 'FDScheme', required: true },
        amount: { type: Number, required: true },
        interestPercent: { type: Number, required: true },
        startDate: { type: Date, default: Date.now },
        maturityDate: { type: Date, required: true },
        lastInterestCalculationDate: { type: Date, default: Date.now },
